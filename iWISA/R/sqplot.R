#'Plot of Non-constant Solar Quiet Daily Variation Estimation of Studied Station
#'
#'This function is used to visualize the estimations of non-constant solar quiet daily variation corresponding to each station.
#'Users would define how many graphs to be put into one page, but the default set is 2 graphs per page.
#'
#'@param x estimation of sq from \code{SQ}
...
#'
#'@details This function is used to visualizing estimation of Sq variation. By specifying names of each stations would
#'add station names at ylab.
#'
...
#'
#'## specify parameters of the wavelet analysis
#'#### for two months:
#'n.levels = 11
#'
...
#'
#'## estimation of sq
#'Sq<- SQ (datasq, si.v=si.v, wf = "la8", n.levels = 10, boundary = "reflection", quantile=0.98)
#'
#'sqplot(Sq, Title="Sq variation", start = start.date, end=end.date, n.station=4,
#'       graphs.per.page=2, station.names=c("HER","KAK","HON","SJG"))
#'
#'@export
